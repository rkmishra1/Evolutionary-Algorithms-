...
**Tags**: <2007> <multi/many> <real/integer/label/binary/permutation>

## Description
Multiobjective evolutionary algorithm based on decomposition

## Reference
Q. Zhang and H. Li. MOEA/D: A multiobjective evolutionary algorithm based on decomposition. IEEE Transactions on Evolutionary Computation, 2007, 11(6): 712-731.
