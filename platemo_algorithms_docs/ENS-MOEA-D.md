...
**Tags**: <2012> <multi/many> <real/integer>

## Description
Ensemble of different neighborhood sizes based MOEA/D

## Reference
S. Zhao, P. N. Suganthan, and Q. Zhang. Decomposition-based multi- objective evolutionary algorithm with an ensemble of neighborhood sizes. IEEE Transactions on Evolutionary Computation, 2012, 16(3): 442-446.
